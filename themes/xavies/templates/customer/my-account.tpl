...
{if $notifications.display_action}
	{foreach $notifications.display_action as $notificationName}
		{if $notificationName == 'submitCreate'}
			{block name='page_content'}
				{include file='customer/_partials/registration-confirmation.tpl'}
			{/block}
		{/if}
	{/foreach}
{else}
...
{*	  </div>*}
	  ...
	  {*
	  {if $notifications.display_action}
		  {if $notifications.display_action|reset == 'submitLogin'}
			  {block name='login_success'}
				{include file='customer/_partials/login-success.tpl'}
			  {/block} 
		  {/if}
		  
		  {if $notifications.display_action|reset == 'submitCreate'}
			  {block name='registration_success'}
				{include file='customer/_partials/registration-success.tpl'}
			  {/block}   
		  {/if}
	  {/if}
	  *}
