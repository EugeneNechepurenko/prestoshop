    ...
    <div class="block-promo">
      <div class="cart-voucher">
              ...
              {foreach from=$cart.vouchers.added item=voucher}
                <li class="cart-summary-line">
                  ...
                  <div class="float-xs-right">
                    <span>{if $voucher.reduction_formatted == "-0.00%"}{else}{$voucher.reduction_formatted}{/if}</span>
		...
		*}
        ...
        <div id="promo-code" class="collapse in{if $cart.discounts|count > 0} in{/if}">
          <div class="promo-code">
            {block name='cart_voucher_form'}
			  <span class="label">{l s='Vul hier jouw kortingscode in' d='Shop.Theme.Checkout'}</span>
