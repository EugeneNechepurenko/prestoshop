...
{if isset($news)}
    {if $prestablog_config.prestablog_socials_actif}
        <div class="social_share_container">
            <p>{l s='DEEL DIT ARTIKEL' d='Shop.Theme.Catalog'}</p>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8.72 16.71">
                              ...
                              <g id="Laag_2" data-name="Laag 2">
                                <g id="Laag_1-2" data-name="Laag 1">
                                  <g id="Facebook">
                                    <path id="Path_1" data-name="Path 1" class="cls-1facebook" d="M5.66,16.71V9.1h2.6l.37-3h-3V4.28c0-.84.28-1.49,1.49-1.49H8.72V.1C8.35.1,7.42,0,6.4,0A3.59,3.59,0,0,0,2.59,3.35a3.49,3.49,0,0,0,0,.56V6.13H0v3H2.6v7.61Z"/>
                                  </g>
                                </g>
                              </g>
                            </svg>
                        </span>
                            <span class="soc-text">{l s='Facebook' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
            ...
            <span class="soc-icon">
                ...
                C26.275,7.229,25.39,8.196,24.253,8.756z"/>
                            ...
                            <span class="soc-text">{l s='Twitter' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
            ...
            <span class="soc-icon">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                    ...
                    C8.054,3.593,7.019,2.501,5.343,2.501H5.348z M2.867,24.334h4.897V9.603H2.867V24.334z"/>
                            ...
                            <span class="soc-text">{l s='Linkedin' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
            ...
            <span class="soc-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve"><g><path d="M20.111 26.147c-2.336 1.051-4.361 1.401-7.125 1.401c-6.462 0-12.146-4.633-12.146-12.265 c0-7.94 5.762-14.833 14.561-14.833c6.853 0 11.8 4.7 11.8 11.252c0 5.684-3.194 9.265-7.399 9.3 c-1.829 0-3.153-0.934-3.347-2.997h-0.077c-1.208 1.986-2.96 2.997-5.023 2.997c-2.532 0-4.361-1.868-4.361-5.062 c0-4.749 3.504-9.071 9.111-9.071c1.713 0 3.7 0.4 4.6 0.973l-1.169 7.203c-0.388 2.298-0.116 3.3 1 3.4 c1.673 0 3.773-2.102 3.773-6.58c0-5.061-3.27-8.994-9.303-8.994c-5.957 0-11.175 4.673-11.175 12.1 c0 6.5 4.2 10.2 10 10.201c1.986 0 4.089-0.43 5.646-1.245L20.111 26.147z M16.646 10.1 c-0.311-0.078-0.701-0.155-1.207-0.155c-2.571 0-4.595 2.53-4.595 5.529c0 1.5 0.7 2.4 1.9 2.4 c1.441 0 2.959-1.828 3.311-4.087L16.646 10.068z"/></g></svg>
                            ...
                            <span class="soc-text">{l s='e-mail' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
            ...
            <span class="soc-icon">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                    ...
                    c0.579,4.255-1.816,8.865-6.102,8.533L15.261,18.655z"/>
                            ...
                            <span class="soc-text">{l s='pinterest' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
            ...
            <span class="soc-icon">
                <svg width="32px" height="28px" viewBox="0 0 32 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
                    <path d="M28.7817528,0.00172488695 C30.8117487,0.00431221738 31.9749312,1.12074529 31.9644402,3.10781507 C31.942147,6.67703739 32.1336065,10.2669583 31.8057648,13.8090137 C30.7147076,25.5813672 17.2181194,31.8996281 7.20714461,25.3808491 C2.71833574,22.4571656 0.196577202,18.3122624 0.0549495772,12.9357897 C-0.0342233715,9.5774348 0.00642900214,6.21519891 0.0300336062,2.85555035 C0.0405245414,1.1129833 1.21157517,0.0146615391 3.01995012,0.00819321302 C7.34746087,-0.00603710433 11.6775944,0.00431221738 16.0064164,0.00172488695 C20.2644248,0.00172488695 24.5237444,-0.00215610869 28.7817528,0.00172488695 L28.7817528,0.00172488695 Z M8.64885184,7.85611511 C7.38773662,7.99113854 6.66148108,8.42606978 6.29310958,9.33228474 C5.90114134,10.2969233 6.17774769,11.1421181 6.89875951,11.8276216 C9.35282156,14.161969 11.8108164,16.4924215 14.2976518,18.7943114 C15.3844131,19.7966007 16.5354102,19.7836177 17.6116843,18.7813283 C20.0185529,16.5495467 22.4070683,14.2982907 24.7824746,12.0327533 C25.9845979,10.8850542 26.1012707,9.56468083 25.1469132,8.60653379 C24.1361858,7.59255976 22.8449191,7.6743528 21.5890476,8.85191291 C19.9936451,10.3488554 18.3680912,11.8172352 16.8395462,13.3777945 C16.1342655,14.093159 15.7200114,14.0048744 15.0566806,13.3440386 C13.4599671,11.7484252 11.8081945,10.2060421 10.1262706,8.70001155 C9.65564653,8.27936164 9.00411403,8.05345704 8.64885184,7.85611511 L8.64885184,7.85611511 L8.64885184,7.85611511 Z"></path>
                            ...
                            <span class="soc-text">{l s='pocket' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
            ...
            <span class="soc-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve"><path d="M18.02 21.842c-2.029 0.052-2.422-1.396-2.439-2.446v-7.294h4.729V7.874h-4.71V1.592c0 0-3.653 0-3.714 0 s-0.167 0.053-0.182 0.186c-0.218 1.935-1.144 5.33-4.988 6.688v3.637h2.927v7.677c0 2.8 1.7 6.7 7.3 6.6 c1.863-0.03 3.934-0.795 4.392-1.453l-1.22-3.539C19.595 21.6 18.7 21.8 18 21.842z"/></svg>
                            ...
                            <span class="soc-text">{l s='tumblr' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
            ...
            <span class="soc-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve"><g><path d="M11.794 15.316c0-1.029-0.835-1.895-1.866-1.895c-1.03 0-1.893 0.865-1.893 1.895s0.863 1.9 1.9 1.9 C10.958 17.2 11.8 16.3 11.8 15.316z"/><path d="M18.1 13.422c-1.029 0-1.895 0.864-1.895 1.895c0 1 0.9 1.9 1.9 1.865c1.031 0 1.869-0.836 1.869-1.865 C19.969 14.3 19.1 13.4 18.1 13.422z"/><path d="M17.527 19.791c-0.678 0.678-1.826 1.006-3.514 1.006c-0.004 0-0.009 0-0.014 0c-0.004 0-0.01 0-0.015 0 c-1.686 0-2.834-0.328-3.51-1.005c-0.264-0.265-0.693-0.265-0.958 0c-0.264 0.265-0.264 0.7 0 1 c0.943 0.9 2.4 1.4 4.5 1.402c0.005 0 0 0 0 0c0.005 0 0 0 0 0c2.066 0 3.527-0.459 4.47-1.402 c0.265-0.264 0.265-0.693 0.002-0.958C18.221 19.5 17.8 19.5 17.5 19.791z"/><path d="M27.707 13.267c0-1.785-1.453-3.237-3.236-3.237c-0.793 0-1.518 0.287-2.082 0.761c-2.039-1.295-4.646-2.069-7.438-2.219 l1.483-4.691l4.062 0.956c0.071 1.4 1.3 2.6 2.7 2.555c1.488 0 2.695-1.208 2.695-2.695C25.881 3.2 24.7 2 23.2 2 c-1.059 0-1.979 0.616-2.42 1.508l-4.633-1.091c-0.344-0.081-0.693 0.118-0.803 0.455l-1.793 5.7 C10.548 8.6 7.7 9.4 5.6 10.75C5.006 10.3 4.3 10 3.5 10.029c-1.785 0-3.237 1.452-3.237 3.2 c0 1.1 0.6 2.1 1.4 2.69c-0.04 0.272-0.061 0.551-0.061 0.831c0 2.3 1.3 4.4 3.7 5.9 c2.299 1.5 5.3 2.3 8.6 2.325c3.228 0 6.271-0.825 8.571-2.325c2.387-1.56 3.7-3.66 3.7-5.917 c0-0.26-0.016-0.514-0.051-0.768C27.088 15.5 27.7 14.4 27.7 13.267z M23.186 3.355c0.74 0 1.3 0.6 1.3 1.3 c0 0.738-0.6 1.34-1.34 1.34s-1.342-0.602-1.342-1.34C21.844 4 22.4 3.4 23.2 3.355z M1.648 13.3 c0-1.038 0.844-1.882 1.882-1.882c0.31 0 0.6 0.1 0.9 0.209c-1.049 0.868-1.813 1.861-2.26 2.9 C1.832 14.2 1.6 13.8 1.6 13.267z M21.773 21.57c-2.082 1.357-4.863 2.105-7.831 2.105c-2.967 0-5.747-0.748-7.828-2.105 c-1.991-1.301-3.088-3-3.088-4.782c0-1.784 1.097-3.484 3.088-4.784c2.081-1.358 4.861-2.106 7.828-2.106 c2.967 0 5.7 0.7 7.8 2.106c1.99 1.3 3.1 3 3.1 4.784C24.859 18.6 23.8 20.3 21.8 21.57z M25.787 14.6 c-0.432-1.084-1.191-2.095-2.244-2.977c0.273-0.156 0.59-0.245 0.928-0.245c1.035 0 1.9 0.8 1.9 1.9 C26.354 13.8 26.1 14.3 25.8 14.605z"/></g></svg>
                            ...
                            <span class="soc-text">{l s='reddit' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
                {if $prestablog_config.prestablog_s_hackernews}
                    <li class="soc-hackernews">
            ...
            <span class="soc-icon">
                <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                    ...
                    21.413,4.435 18.689,4.435 "/>
                            ...
                            <span class="soc-text">{l s='hackernews' mod='prestablog'}</span>
                        </a>
                    </li>
                {/if}
            </ul>
    ...
    {if (sizeof($news->products_liaison))}
        <div id="blog_product_linked">
            <p class="prestablogtitle">{l s='Related products' mod='prestablog'}</p>
                    ...
                    <div class="productslinks">
                        <div class="wrap_blog">
                            <div>
                                ...
                                <div class="image_buy">
                                    {if $product.image_presente}
                                        {PrestaBlogContent return=$product.thumb}
                                    {else}
                                        <img src="{$prestablog_theme_dir_img|escape:'html':'UTF-8'}product_link_white.jpg" alt ="">
                                    {/if}
                                    <button><i class="material-icons shopping-cart">shopping_cart</i></button>
                                </div>
...
{if $prestablog_config.prestablog_author_about_actif}
{if $author_firstname}
<div id="prestablogauthor" itemprop="author" itemscope itemtype="https://schema.org/Person">
  <img src="{$prestablog_author_upimg|escape:'html':'UTF-8'}{$news->author_id|intval}.jpg" class="author" alt="{$author_firstname|escape:'htmlall':'UTF-8'}" itemprop="thumbnail">
  <p class="prestablogtitle" id="prestablog_article" itemprop="headline">{l s='About the author' mod='prestablog'}</p>

  <a class="blog_link" href="{PrestaBlogUrl item=author au=$news->author_id titre=$author_firstname}" itemprop="name">{$author_pseudo|escape:'htmlall':'UTF-8'}</a>
  <div id="prestablogfont">
  <p itemprop="text">{PrestaBlogContent return=$author_bio_crop}</p>
</div>
  <a href="{PrestaBlogUrl item=author au=$news->author_id titre=$author_firstname}" class="blog_link"  itemprop="url"><i class="material-icons">search</i> {l s='Read more' mod='prestablog'}</a>
</div>
<div class="clearfix"></div>
{/if}
{/if}
{/if}
{hook h='displayRating'}
	<div class="clearfix"></div>
{if (sizeof($news->articles_liaison))}
<div class="clearfix"></div>
<div id="blog_article_linked">
    <p class="prestablogtitle">{l s='Related posts' mod='prestablog'}</p>
    <ul id="blog_list_1-7">
                ...
                <div class="block_bas">
                    ...
                    <p class="h3title">
                        ...
                        <br /><span class="date_blog-cat">{l s='Published :' mod='prestablog'}
                            {dateFormat date=$article.date full=1}
                        </span>
                    </p>
                </div>
