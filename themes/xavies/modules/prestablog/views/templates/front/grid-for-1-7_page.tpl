...
{block name='head_seo'}
  ...
  {/if}
    {block name='head_hreflang'}
      {foreach from=$urls_redirect item=pageUrl key=code}
...
{/block}
	  ...
	  {block name='content'}
		...
		{if !isset($tpl_unique) && isset($tpl_filtre_cat_side) && $tpl_filtre_cat_side}{PrestaBlogContent return=$tpl_filtre_cat_side}{/if}
