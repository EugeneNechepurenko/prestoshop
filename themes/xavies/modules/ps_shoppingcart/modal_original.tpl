  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title h6 text-sm-center" id="myModalLabel"><span class="cart_title_icon">&gt;</span>{l s='mijn winkelmandje' d='Shop.Theme.Checkout'}</h4>
      ...
      <div class="modal-body">
        <div class="row cart_discount_row">
          <div class="cart_discount_container">
            <p>Nog … kg voor GRATIS levering.</p>
            <p>Nog € … voor 10% KORTING.</p>
          </div>
        </div>
