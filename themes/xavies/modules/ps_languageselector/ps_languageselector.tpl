...
<div class="search_switcher">
    {foreach from=$languages item=language}
        <a href="{url entity='language' id=$language.id_lang}" class="lang_switcher_btn{if $language.id_lang == $current_language.id_lang} active{/if}" data-iso-code="{$language.iso_code}">{$language.iso_code}</a>
    {/foreach}
</div>
{*
