  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <span class="h2">{l s='Write your review' d='Modules.Productcomments.Shop'}</span>
      ...
      <div class="modal-body">
        <form id="post-product-comment-form" action="{$post_comment_url nofilter}" method="POST">
          ...
          <div class="row">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					<label class="form-label">{l s='Captcha' mod='eicaptcha'}<sup class="required">*</sup></label>
					{**
					 ...
					 *}
					 <div class="col-md-12">
						<div class="g-recaptcha" data-sitekey="6LffvyYTAAAAAMEBChHLUDbCe_lR4BP_rZIL-ERN" id="captcha-box" data-theme="light"></div>
					 </div>
